...
const SellPage = () => {
    return (
        <>
        <Navbar />
        <div className="bg-[#fcf9f8] text-[#1c1b1b] font-manrope selection:bg-[#ffe08d] selection:text-[#241a00]">
            <main>
                {/* Hero Section */}
                <section className="relative min-h-[80vh] flex items-center justify-center pt-20 overflow-hidden">
                    <div className="absolute inset-0 z-0">
                        <img 
                            ...
                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuCZQ2GqRJynWYopdJKNSOI0AwFI6TWe466rU8kvbZRfMqmc2ihx5po-nnkzCWjHBQdyeczOG8TIShFlD83X4lLw5w0G4z1oMXrehWdl9RjVCNJXAAHfFCowSdjaYX9x52EfwE5xHriRU_ceqZxlhrmSMPPz5uZSD3SpVZX454Ywp09hp40cUVnE0nIO63HomGzliq-KZ2u-1AFhxHHaAwEl_YE4kKCzUlwerpii6V3RDwC6JrbBUWvwjVh5-hy8nZ2iNXhJiHi7Pg7d"
                        />
                    ...
                    <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                        ...
                        <motion.p 
                            ...
                            className="text-[#5f5e59] text-lg md:text-xl font-light tracking-wide max-w-2xl mx-auto"
                        >
                            Valutazione professionale e acquisto immediato per auto di prestigio e non solo. La tua eccellenza merita un trattamento su misura.
                        </motion.p>
                    </div>
                </section>
