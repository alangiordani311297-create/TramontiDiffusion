...
export default function OfficinaCertificataPage() {
    const services = [
        { 
            label: 'Diagnostica Ufficiale Leonardo', 
            desc: 'La più avanzata tecnologia di diagnostica per supercar e auto di lusso, inclusi i sistemi Leonardo e tester originali per Ferrari, Lamborghini, Maserati e Porsche, per individuare e risolvere ogni anomalia con precisione clinica.',
            img: '/immagini/diagnosi ufficiale leonardo.jpg'
        },
        { 
            label: 'Tagliandi e Manutenzione Ordinaria', 
            desc: 'Piani di manutenzione programmata eseguiti rigorosamente secondo le specifiche della casa madre. Utilizzo esclusivo di ricambi originali e lubrificanti ad alte prestazioni per garantire la massima efficienza e longevità al tuo veicolo.',
            img: '/immagini/tagliando auto.jpg'
        },
        { 
            label: 'Assetto e Bilanciatura Elettronica', 
            desc: 'Messa a punto di assetti sportivi e ricalibrazione elettronica delle sospensioni. Ottimizziamo la geometria del tuo veicolo per offrire un\'esperienza di guida perfetta su strada e prestazioni ottimali in pista.',
            img: '/immagini/01_Ferrari_SF90_03.webp'
        }
    ];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch min-h-[70vh]">
                    ...
                    <div className="flex flex-col justify-center pr-0 lg:pr-16 py-12 order-2 lg:order-1">
                        ...
                        <h1 className="text-5xl md:text-6xl lg:text-7xl text-white font-serif font-bold leading-tight mb-6">
                            L'officina certificata per <br/> le tue Supercar.
                        </h1>

                        <p className="text-gray-400 text-base md:text-lg mb-4">
                            Prenota il tuo prossimo intervento in officina
                        </p>
                    ...
                    <div className="relative order-1 lg:order-2 flex items-center justify-center p-4 lg:p-12">
                        <div className="h-[300px] lg:h-[450px] w-full max-w-[600px] relative overflow-hidden rounded-3xl shadow-2xl border border-white/5">
                            <img
                                src="/immagini/foto officina certificata.jpg"
                                alt="Officina certificata"
                        ...
                        <div className="absolute -bottom-6 -left-6 lg:left-0 bg-[#1c1b1b] border-t-4 border-[#e9c176] px-8 py-6 shadow-2xl max-w-lg hidden md:block border border-white/5">
                            <h3 className="text-2xl font-bold text-white mb-4">
                                Da oltre 50 anni, l'eccellenza <br/> nella meccanica sportiva.
                            </h3>
                            <p className="text-gray-400 text-base leading-relaxed font-light">
                                La nostra officina è un tempio della meccanica di precisione. Ogni intervento viene eseguito seguendo rigorosamente gli standard della casa madre per vetture Ferrari, Porsche e Lamborghini.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section id="dettagli" className="container mx-auto px-6 mt-24">
                <div className="py-16 md:py-24">
                    <div className="flex flex-col items-center justify-center text-center mb-24 px-6">
                        ...
                        >
                            Interventi specializzati <br /> curati in ogni dettaglio
                        </motion.h2>
                        <motion.p 
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                        ...
                        {services.map(({ label, desc, img }, idx) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Link
                                        href="https://api.whatsapp.com/send?phone=393462319293&text=Ciao%2C%20vorrei%20prenotare%20un%20appuntamento%20in%20officina"
            ...
            <section className="container mx-auto px-6 mt-20">
                <div className="border-t border-white/10 pt-16 flex flex-col items-center text-center gap-10">
                    <div className="max-w-2xl">
                        <h3 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">L'affidabilità su cui puoi contare.</h3>
                        <p className="text-gray-400 text-base md:text-lg">Porta la tua auto nel nostro centro e dormi sonni tranquilli.</p>
                    </div>
                    <Link
                        href="/#contact"
